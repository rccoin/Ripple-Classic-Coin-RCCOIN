...
uint256 hashGenesisBlock("0xfede839d7966e2614a749a8480c7b8f84bad9593ee7d1ad1c5a3b553547659fb");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Rccoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Rccoin Signed Message:\n";
...
{
    // Rccoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    if (nHeight == 5)
    {
        return 237500000 * COIN + nFees;
    }

    int64 nSubsidy = 200000000;
...
static const int64 nTargetTimespan = 302400; // Rccoin: 3.5 days
static const int64 nTargetSpacing = 150; // Rccoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Rccoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rccoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Rccoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x72ecf9ecc93b3603ca4762c006f50aa97bbf42882be95b86086ecdaca2965c3a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "India today online cover latest headlines breaking news India news videos.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("1b93a6afa953a5a8daadeaba9b165a996e79638c10d0f823ad92a150918841206bb8679c35c30291c67ac0c1884ea7a59351ec476671cb1ad5e5431fb2cc9f062e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512981257;
        block.nBits    = 504365644;
        block.nNonce   = 3775203868;

        if (fTestNet)
        {
            block.nTime    = 1512981257;
            block.nNonce   = 3341178455;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xecc161da325dbd77cd17d2d944682beedea423143b632009102828de87d7fb76"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Rccoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RccoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RccoinMiner : ProcessBlock, block not accepted");
    }
